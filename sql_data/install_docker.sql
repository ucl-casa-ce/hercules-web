...
\COPY public.p1_input FROM '/opt/hercules/data/live/P1/P1_input.csv' DELIMITER ',' CSV HEADER;
\COPY public.p1_grouped_data FROM '/opt/hercules/data/live/P1/P1_grouped_data.csv' DELIMITER ',' CSV HEADER;
...
-- Copy Data into tables
COPY public.p2_input FROM '/opt/hercules/data/live/P2/P2_input.csv' DELIMITER ',' CSV HEADER;
COPY public.p2_grouped_data FROM '/opt/hercules/data/live/P2/P2_grouped_data.csv' DELIMITER ',' CSV HEADER;
...
-- Copy Data into tables
COPY public.p3_input FROM '/opt/hercules/data/live/P3/P3_input.csv' DELIMITER ',' CSV HEADER;
COPY public.p3_grouped_data FROM '/opt/hercules/data/live/P3/P3_grouped_data.csv' DELIMITER ',' CSV HEADER;
...
-- Copy Data into tables
COPY public.p4_input FROM '/opt/hercules/data/live/P4/P4_input.csv' DELIMITER ',' CSV HEADER;
COPY public.p4_grouped_data FROM '/opt/hercules/data/live/P4/P4_grouped_data.csv' DELIMITER ',' CSV HEADER;
